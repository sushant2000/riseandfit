...
//Check for duplicate comment by same id
  ...
  if(mysqli_num_rows($dup)>0){
    ...
    $id = $_REQUEST['id'];
    // echo $id;
    header("Location:http://localhost/riseandfit/Blog/BlogPage/displayPost.php?id=$id");
    exit;
	} else {
 ...
 <div class="blog">
  <div class="blogPost">
     ...
     <div class="comment-section">
         ...
         <button type="submit" name="submit" id="bbtn" class="button button-contactForm btn_1 boxed-btn headerBtn"
              onclick="return mess();">Post Comment</button>
          </div>
</form>
